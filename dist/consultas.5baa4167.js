...
var _postUser = require("./src/js/postUser");
var _getUser = require("./src/js/getUser");
...
boton.addEventListener("click", function() {
    ...
    (0, _postUser.postUser)(consultasIN, detalleConM, selectO, dateD);
});
console.log((0, _getUser.GetUser)());

},{"./src/js/postUser":"cJ07F","./src/js/getUser":"c3dG9"}],"cJ07F":[function(require,module,exports) {
